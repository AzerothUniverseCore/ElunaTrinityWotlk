...
public:
    ...
    void OnConfigLoad(bool /*reload*/) override
    {
        ...
        dungeons =
        {
            ...
            {778, sConfigMgr->GetIntDefault("Solocraft.SiegeNiuzaoTemple.Level", 80) },                   // Siege of Niuzao Temple S6
            ...
            {794, sConfigMgr->GetIntDefault("Solocraft.WellEternity.Level", 80) },                        // Well of Eternity S7
            {795, sConfigMgr->GetIntDefault("Solocraft.Skyreach.Level", 80) },                            // Skyreach S6
            {796, sConfigMgr->GetIntDefault("Solocraft.HallsValor.Level", 80) },                          // Halls of Valor S7
            {797, sConfigMgr->GetIntDefault("Solocraft.Nighthold.Level", 80) },                           // Nighthold S8
        ...
        diff_Multiplier =
        {
            ...
            {778, sConfigMgr->GetFloatDefault("Solocraft.SiegeNiuzaoTemple", 5.0) },                      // Siege of Niuzao Temple S6
            ...
            {794, sConfigMgr->GetFloatDefault("Solocraft.WellEternity", 5.0) },                           // Well of Eternity S7
            {795, sConfigMgr->GetFloatDefault("Solocraft.Skyreach", 5.0) },                               // Skyreach S6
            {796, sConfigMgr->GetFloatDefault("Solocraft.HallsValor", 5.0) },                             // Halls of Valor S7
            {797, sConfigMgr->GetFloatDefault("Solocraft.Nighthold", 5.0) },                              // Nighthold S8
        ...
        diff_Multiplier_Heroics =
        {
            ...
            {796, sConfigMgr->GetFloatDefault("Solocraft.HallsValorH", 10.0) },                           // Halls of Valor S7 HM 10 
            {797, sConfigMgr->GetFloatDefault("Solocraft.NightholdH", 10.0) },                            // Nighthold S8 HM 10 
        };
